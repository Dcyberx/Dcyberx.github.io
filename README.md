...
<head>
  ...
  <style>
    ...
    .logo-ascii{
      ...
      animation: scrollUp 20s linera infinite;
    }

    @keyframes scrollUp {
      0% {transform: translateY(100%); }
      100% {transform: translate Y(-100%); }
    }
...
<title>Terminal Button Example</title>
<style>
/* Container to make it terminal-like */
.terminal-btn {
    display: inline-flex;
    align-items: center;
    background: #000;
...
<a href="playlist.html" class="terminal-btn">
